...
// Google Fonts
wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@500;700&display=swap',
array(), null);
...
// SimpleBar JS
wp_enqueue_script('simplebar-script', 'https://cdn.jsdelivr.net/npm/simplebar@latest/dist/simplebar.min.js',
array('jquery'), null, true);

// Swiper JS
wp_enqueue_script('swiper-script', 'https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js', array('jquery'), null,
true);
