                    ...
                    <div class="swiper-slide voice__item">
                        <a href="./result_details.html" class="voice__link">
                            <div class="voice__img">
                                <picture>
                                    <source media="(max-width: 767px)" srcset="./img/voice01-sp.jpg">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/voice01.jpg" width="270"
                                        height="190" alt="拳をあげて歌う男性" loading="lazy">
                                </picture>
                            </div>
                            <div class="voice__text-block">
                                <h3 class="voice__title">証券会社勤務　丸山さん</h3>
                                <p class="voice__text">昔やっていた音楽活動で、副収入が得られるようになったので、毎日充実するようになりました。</p>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="./result_details.html" class="voice__link">
                            <div class="voice__img">
                                <picture>
                                    ...
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/voice02.jpg" width="270"
                                        height="190" alt="犬を抱いてピアノの前に座る女性" loading="lazy">
                                </picture>
                            </div>
                            <div class="voice__text-block">
                                <h3 class="voice__title">IT会社勤務　S.Eさん</h3>
                                <p class="voice__text">プロの指導が受けられるので、技術が確実に上がるし、音楽への考え方とかも勉強できて最高です。</p>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="./result_details.html" class="voice__link">
                            <div class="voice__img">
                                <picture>
                                    ...
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/voice03.jpg" width="270"
                                        height="190" alt="ギターを弾く男性" loading="lazy">
                                </picture>
                            </div>
                            <div class="voice__text-block">
                                <h3 class="voice__title">都内大学生　田森さん</h3>
                                <p class="voice__text">就職する前にビジネスの事が学べるし、好きな音楽で稼げるようになったので選択肢が増えました。</p>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="./result_details.html" class="voice__link">
                            <div class="voice__img">
                                <picture>
                                    <source media="(max-width: 767px)" srcset="./img/voice01-sp.jpg">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/voice01.jpg" width="270"
                                        height="190" alt="こぶしを挙げて歌う男性" loading="lazy">
                                </picture>
                            </div>
                            <div class="voice__text-block">
                                <h3 class="voice__title">証券会社勤務　丸山さん</h3>
                ...
                <ul class="blog__list">
                    <li class="c-blog__item blog__item">
                        <a href="./blog_details.html">
                            <div class="top__img-wrapper">
                                <picture>
                                    <source media="(max-width: 767px)" srcset="./img/blog01-sp.jpg">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/blog01.jpg" width="260"
                                        height="200" alt="拳をあげて歌う女性" loading="lazy">
                                </picture>
                                <span class="c-blog__label">SNS</span>
                            </div>
                            <p class="blog__title">フォロワーではなくファンを増やせとは？</p>
                    ...
                    <li class="c-blog__item blog__item">
                        <a href="./blog_details.html">
                            <div class="top__img-wrapper">
                                <picture>
                                    <source media="(max-width: 767px)" srcset="./img/blog02-sp.jpg">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/blog02.jpg" width="260"
                                        height="200" alt="頭を掻いて悩む男性" loading="lazy">
                                </picture>
                                <span class="c-blog__label">集客方法</span>
                            </div>
                            <p class="blog__title">集客してる間は売れないという法則</p>
                            <time datetime="2025-10-26">0000.00.00</time>
                        </a>
                    </li>
                    ...
                    <li class="c-blog__item blog__item">
                        <a href="./blog_details.html">
                            <div class="top__img-wrapper">
                                <picture>
                                    <source media="(max-width: 767px)" srcset="./img/blog03-sp.jpg">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/blog03.jpg" width="260"
                                        height="200" alt="ギターを弾く生徒" loading="lazy">
                                </picture>
                                <span class="c-blog__label">ギター</span>
                            </div>
                            <p class="blog__title">アルペジオが劇的に向上する3つの習慣</p>
                            <time datetime="2025-10-26">0000.00.00</time>
                        </a>
                    </li>
                </ul>
